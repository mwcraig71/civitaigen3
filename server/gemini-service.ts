...
- For body poses, use view-angle + position tags drawn from this vocabulary: "front view, standing" / "front view, standing, feet apart" / "front view, standing, legs crossed" / "rear view, standing" / "rear view, standing, on toes" / "rear view, standing, knee bent" / "front view, seated on floor" / "front view, seated on floor, legs open" / "front view, seated on floor, knees bent" / "front view, seated on floor, leaned back on hands" / "rear view, seated on floor, one knee up" / "front view, prone, on stomach" / "front view, prone, on stomach, feet raised" / "profile view, prone" / "rear view, prone" / "front view, lying on back" / "front view, lying on back, legs apart" / "front view, lying on back, knees bent" / "overhead view, lying on back" / "overhead view, lying on back, legs apart" / "overhead view, lying on back, legs akimbo, feet apart" / "elevated view, lying on back, high kick" / "front view, squatting, one leg extended" / "profile view, squatting" / "profile view, squatting, leaning back, high kick" / "rear view, squatting, knees together" / "front view, kneeling" / "front view, kneeling, legs apart" / "front view, kneeling, leaning back, legs wide apart" / "profile view, kneeling, high kick" / "rear view, kneeling, forward on hands" / "front view, crawling" / "front view, crawling, legs wide apart" / "profile view, crawling" / "rear view, crawling, legs apart" / "rear view, crawling, legs split". When the prompt lacks a pose or the current pose is vague, substitute a specific descriptor from this vocabulary that fits the scene.`;
...
- For body poses, weave the position into prose using this vocabulary as inspiration — combine a viewpoint (front-facing, from behind, in profile, overhead, from an elevated angle) with a base position (standing, seated on the floor, prone on her stomach, lying on her back, squatting, kneeling, crawling) and a detail modifier (feet apart, weight on one leg, legs crossed, one knee up, leaned back on her hands, legs wide apart, forward on hands, legs akimbo with feet together, on tiptoes, etc.). When the prompt lacks a specific pose or the current pose is vague, introduce a vivid, specific one from this vocabulary that feels natural in the scene.
